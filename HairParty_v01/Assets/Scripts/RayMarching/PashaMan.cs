...
public class PashaMan : SceneViewFilter
{
    ...
    void OnRenderImage(RenderTexture source, RenderTexture destination)
    {
        ...
        Vector3 leftHandPosition = kinect.GetJointPosition(userId, leftHandIndex);
        Vector3 rightHandPosition = kinect.GetJointPosition(userId, rightHandIndex);
