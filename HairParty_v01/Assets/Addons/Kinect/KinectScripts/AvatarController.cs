...
{	
	...
	public Vector3 moveRate = new Vector3(1, 1, 1);
...
//			return;
	...
	{
		if((moveRate.magnitude == 0f) || !kinectManager ||
...
//		else
	...
	{
		float xPos = (jointPosition.x - offsetPos.x) * moveRate.x;
		float yPos = (jointPosition.y - offsetPos.y) * moveRate.y;
		float zPos = !mirroredMovement && !posRelativeToCamera ? (-jointPosition.z - offsetPos.z) * moveRate.z : (jointPosition.z - offsetPos.z) * moveRate.z;
