Shader "Custom/Tesselation Plus Noise" {
	Properties{
	...
	_Displacement("Displacement", Range(0, 1.0)) = 0.3
		...
		_NoiseMagnitude("Noise Magnitude", Range(0, 1)) = 0.0
	}
		SubShader{
...
#include "Tessellation.cginc"
	...
	void disp(inout appdata v)
	{
		...
		d = d * 0.5 - 0.5 + _DispOffset + noise(v.vertex.x * _Time * 0.5) * 0.5 * _NoiseMagnitude;
